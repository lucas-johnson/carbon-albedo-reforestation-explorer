    ...
    output$docs <- renderUI({
        ...
        return(list(
            ...
            div("If you encounter any problems, or have any recommendations for how to improve the app's functionality, please submit a", 
                tags$a("github issue", href = "https://github.com/lucas-johnson/reforestation-recommendations/issues"),
                "or reach out to the app developers using the contact information provided below."
            ),
            h2("Citation"),
            p("Johnson, Yang, Erb, Bright, Domke, Frescino, Schaaf, Healey, (in review), Integrating albedo offsets in reforestation decisions for climate mitigation outcomes in 2050: a case study in the USA."),
            h2("References"),
            ...
            p("Domke, Walters, Nowak, Greenfield, Smith, Nichols, Ogle, Coulston, Wirth (2022). Greenhouse Gas Emissions and Removals From Forest Land, Woodlands, Urban Trees, and Harvested Wood Products in the United States, 1990–2020. (US Dept. Ag. For. Service, Madison, WI; https://doi.org/10.2737/FS-RU-382)."),
            ...
            p("Healey, S., & Yang, Z. (2023). Carbon storage and carbon-equivalent albedo impact for US forests, by age and forest type [Data set]. Zenodo. https://doi.org/10.5281/zenodo.8320433"),
            h2("Contact information"),
            div(tags$a("Lucas Johnson", href="https://lucaskjohnson.com"),
                "- johnsl27@oregonstate.edu"),
            div("Zhiqiang Yang - zhiqiang.yang@usda.gov"),
            div(tags$a("Sean Healey", href="https://orcid.org/0000-0003-3498-4266"), 
